...
<style>
.bg-div {
	background: url(../image/bgImage/墙壁背景-031.jpg) no-repeat center;
...
<body>
	...
	<hr
		style="width: auto; color: aquamarine; height: auto; display: block" />
				...
				<div class="col-md-4">
					<form>
						<div class="form-group">
							<label>学号：</label> <input class="form-control" type="text"
								id="userName" onchange="checkUsername();"> <label
								id="checkuserName" class="alert_star">*</label>
						</div>

						<div class="form-group">

							<label>密码：</label> <input class="form-control" type="text"
								id="password"> <label id="checkpassword"
								class="alert_star">*</label>
						</div>

						<div class="form-group">
							<label>姓名：</label> <input class="form-control" type="text"
								id="name"> <label id="checkname" class="alert_star">*</label>
						</div>

						<div class="form-group">
							<label>性别：</label> 男<input id="gender" type="radio" value="男"
								checked> 女<input name="gender" type="radio" value="女">
							<label id="checkgender" class="alert_star">*</label>
						</div>

						<div class="form-group">
							<label>年级：</label> <select class="form-control" id="grade">
							...
							</td> <label id="checkgrade" class="alert_star">*</label>
						</div>

						<div class="form-group">
							<label>学院：</label>
							<select class="form-control" id="department" onchange="updateMajor();">
								<option value="">请选择</option>
						...
						<div class="form-group">
							<label>专业：</label> <select class="form-control" id="major"
								name="major">
								<option value="">请选择</option>
						...
						<div class="form-group">
							<label>Email：</label> <input class="form-control" type="text"
								id="email" onchange="checkEmail();"> <label
								id="checkemail" class="alert_star">*</label>
						</div>

						<div class="form-group">
							<label>QQ：</label> <input class="form-control" type="text" id="qq">
						</div>

						<div class="form-group">
							<label>微信：</label> <input class="form-control" type="text" id="wechat">
						</div>

						<div class="form-group">
							<label>手机号：</label> <input class="form-control" type="text" id="phone">
						</div>

						<div class="form-group">
							<label>身份验证问题：</label> <select class="form-control"
								id="valid_ques">
								<option value="">请选择</option>
						...
						<div class="form-group">
							<label>身份验证答案：</label> <input class="form-control" type="text"
								id="valid_ans"> <label id="checkvalid_ans" class="alert_star">*</label>
						</div>
						<br />
