...
<body>
<h2>买书记录</h2><a href="ShowAllNotCourseBooks?type=买书记录">查看更多</a>
	<table>
		<c:forEach items="${requestScope.notCourseBuyBooks}" var="book">
			<tr>
				<td>ISBN：</td>
				<td>${book.isbn }</td>
				<td>书名：</td>
	...
	<h2>卖书记录</h2><a href="ShowAllNotCourseBooks?type=卖书记录">查看更多</a>
	<table>
		<c:forEach items="${requestScope.notCourseSellBooks}" var="book">
			<tr>
