...
<title>${school}-${grade}级-${type}</title>
</head>
<body>
	<table>
		<c:forEach items="${requestScope.sellBooks}" var="book">
			<tr>
	...
	<div>
		<c:forEach var="i" begin="1" end="${pageCount}" step="1">
			<a href="ShowAllSchoolBooks?pageNow=${i}&type=卖书记录&school=${school}&grade=${grade}">第${i}页</a>
		</c:forEach>
	</div>
</body>
</html>